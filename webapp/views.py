...
#send_mail(email_subject, email_message, 'baranjul@gmail.com',
#			['p12583@iitb.ac.in'],fail_silently=False)
            messages.success(
                request,
...
Email:""" + user.email + """
Waiting for your your approval"""
#            send_mail(email_subject, email_message, 'baranjul@gmail.com', ['p12583@iitb.ac.in'],fail_silently=False)
...
def content(request, lang):
    ...
    filter_review = Subject.objects.all().filter(review__gte=1)
...
def search(request, lang):
    ...
    filter_review = filter_lang.filter(review__gte=1)
